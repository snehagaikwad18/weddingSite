          ...
          <div>
            <div className=' bg-[#FAFAFA] px-10 flex flex-col gap-5  sm:flex sm:flex-row sm:justify-center sm:gap-5 sm:px-5 md:pt-8 '>
              <div className="p-5 bg-white drop-shadow-2xl rounded-[8px] flex flex-col items-center gap-5 poppins-regular">
                <div className="w-full sm:w-[150px] lg:w-[200px] xl:w-[250px] xl:h-[170px]">
                  <img src={service1} alt="" className='object-cover sm:h-full sm:w-full gallery-img' />
                </div>
              ...
              <div className="p-5 bg-white drop-shadow-2xl rounded-[8px] flex flex-col items-center gap-5 poppins-regular">
                <div className="w-full sm:w-[150px] lg:w-[200px] xl:w-[250px] ">
                  <img src={service2} alt="" className=' object-cover sm:h-full sm:w-full gallery-img' />
                </div>
                <h1 className='text-[#90998B]'>Ceremony</h1>
              </div>

              <div className="p-5 bg-white drop-shadow-2xl rounded-[8px] flex flex-col items-center gap-5 poppins-regular  ">
                <div className="w-full sm:w-[150px] sm:h-[100px] lg:w-[200px] lg:h-[130px] xl:w-[250px] xl:h-[170px] ">
                  <img src={service3} alt="" className='object-cover w-full h-full sm:h-full sm:w-full gallery-img ' />
                </div>
